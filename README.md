...
In order to prevent you from re-enventing the wheel, wo wrote a little `api` helper script, that enables you to make api calls without having to bother about HTML entities. Simply make the request and use the data.
